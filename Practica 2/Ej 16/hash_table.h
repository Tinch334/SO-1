...
//Returns the given element if it exists, oterwise NULL.
void *htable_get(HashTable table, void *data) ;

//Deletes the given element from the hash table, returns 1 if successful, 0 otherwise.
int htable_delete(HashTable table, void *data);
