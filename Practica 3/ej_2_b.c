...
//Puede ocurrir un deadlock si todos los filosofos toman el tenedor de su derecha, impidiendo que ninguno pueda agarrar el de su izquierda.
...
int main() {
    ...
    for (i = 0; i < N_FILOSOFOS; i++) {
        if (i == 0)
            pthread_create(&filo[i], NULL, filosofo_z, i + (void*)0);
        else
